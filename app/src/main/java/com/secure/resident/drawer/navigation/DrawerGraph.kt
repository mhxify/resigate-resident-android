...
import com.secure.resident.drawer.requestguest.presentation.view.RequestGuestStatusScreen
...
fun NavGraphBuilder.drawerGraph(navController: NavController) {
    ...
    navigation(
        ...
        composable(DrawerRoute.REQUEST_GUEST_STATUS) {
            RequestGuestStatusScreen(navController)
        }
    }
}